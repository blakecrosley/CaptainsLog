...
| Apple Watch / Apple TV Availability | No action for the first release | Current readiness shows Captain's Log has no watchOS or tvOS app target or scheme. Return and Banana List are useful local precedents if those platforms are intentionally added later, but they are separate apps and do not make Captain's Log Watch or TV ready. |
