...
| Apple Vision Pro Availability | Opt out for the first release unless a Vision Pro/TestFlight pass is completed | Apple makes compatible iPhone and iPad apps available on Apple Vision Pro by default unless edited in App Store Connect. Captain's Log has not been QA'd on Vision Pro, so keep the first release limited to tested iPhone and iPad surfaces unless product explicitly accepts that extra platform. |
| Apple Silicon Mac Availability | Opt out for the first release unless a Mac/TestFlight pass is completed | Apple can make compatible iPhone and iPad apps available on Apple Silicon Macs through the Mac App Store unless availability is edited. Captain's Log has not been QA'd as an iPad app on Mac, so keep the first release limited to tested iPhone and iPad surfaces unless product explicitly accepts that extra platform. |
