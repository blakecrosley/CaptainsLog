...
- Apple says iPhone and iPad apps are available on Apple Vision Pro by default unless availability is edited in App Store Connect. Captain's Log has not been QA'd on Vision Pro, so the first-submission recommendation is to opt out unless a Vision Pro/TestFlight pass is completed.
- Apple says users on Macs with Apple silicon can access iPhone and iPad apps through the Mac App Store unless availability is edited. Captain's Log has not been QA'd as an iPad app on Mac, so the first-submission recommendation is to opt out unless a Mac/TestFlight pass is completed.
...
- Apple Vision Pro availability: opt out unless product completes and accepts a Vision Pro/TestFlight pass.
