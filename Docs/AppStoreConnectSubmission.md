...
- Current linked Kit941 commit: `0a19f967dc59a7d5b0b4e8daed7f63ef1f5b2e38`
...
- The export manifest records the local `Kit941` package commit and dirty state because the app links `../941Kit` directly. Current readiness shows Kit941 clean and synced with `origin/main` at `0a19f967dc59a7d5b0b4e8daed7f63ef1f5b2e38`. Future linked library-source drift is still reported before export/submission work.
