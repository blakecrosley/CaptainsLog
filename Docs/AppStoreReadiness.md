...
- Connected-device UI tests now run on Blake's iPhone 17 Pro Max. The May 17, 2026 `CaptainsLogUITests` run passed 2 tests with 0 failures, covering first-run Sign in with GitHub and Use Demo Data actions, fixture dashboard launch, Settings, Privacy & Data, and selected-day journal detail.
...
- The reviewer/demo path has a device UI test pass for first-run actions, fixture dashboard, settings, privacy, and selected-day journal detail.
